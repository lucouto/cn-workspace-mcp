...
| 2026-09-23 | `pyproject.toml` | optional extra `cn = ["pillow>=11.0.0", "openpyxl>=3.1.0"]` (openpyxl added in Phase 2, MIT, uses defusedxml) | Image resizing; sheet-aware XLSX reading. Deploy must install `--extra cn` (Dockerfile, Phase 4) |
